<template>
	<div id="app">
		<span>
			<button class="vermelho" @click="componente = 'Vermelho'">Carregar Componente <strong></strong> Vermelho</button>
		...
		<!-- Modo de como usa o components-->
		<!-- Fazendo tambem selecionar com o @click para escolher a cor!-->
		<components :is="componente">
			<span slot="conteudo">Conteúdo do Componente <strong>{{ componente }}</strong></span>
		</components>

	
		<!-- Utilizando slot nos arquivos.-->
	<!--<Vermelho>
